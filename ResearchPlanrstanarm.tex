...
\subsection*{Advanced hierarchical modeling for EHR should be accessible}
...
\subsection*{Advanced hierarchical modeling for EHR must be fast and flexible to be useful}
...
\subsection*{Exploration of hierarchical model output and convergence diagnostics should be refined} 
